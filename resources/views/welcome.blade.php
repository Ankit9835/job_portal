              ...
              <a href="{{ route('jobs.show', [$job->id, $job->slug]) }}" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
                ...
                <div class="job-category align-self-center">
                  ...
                  @elseif($job->type == 'parttime')
                   <div class="p-3">
                    <span class="text-info p-2 rounded border border-warning">{{ $job->type }}</span>
                  </div>
                  @else
                  <div class="p-3">
                    <span class="text-info p-2 rounded border border-danger">{{ $job->type }}</span>
                  </div>
                   @endif
                </div>  
              </a>
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6 text-center" data-aos="fade">
            ...
            <p><a href="{{ route('register') }}" class="btn btn-outline-warning py-3 px-4">Job Seeker</a> <a href="{{ route('emp') }}" class="btn btn-outline-warning py-3 px-4">Employer</a></p>
